...
#                                  my_mail GET    /my_mail(.:format)                                                                                public/mail#index
...
#        create_letter_api_v1_letter_queue POST   /api/v1/letter_queues/:id(.:format)                                                               api/v1/letter_queues#create_letter {:format=>:json}
...
#                  new_api_v1_letter_queue GET    /api/v1/letter_queues/new(.:format)                                                               api/v1/letter_queues#new {:format=>:json}
#                 edit_api_v1_letter_queue GET    /api/v1/letter_queues/:id/edit(.:format)                                                          api/v1/letter_queues#edit {:format=>:json}
