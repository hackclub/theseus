module Public
  class ApplicationController < ActionController::Base
    ...
    helper_method :current_user, :current_public_user, :public_user_signed_in?, :authenticate_public_user!
    ...
    def current_public_user
      @current_user ||= Public::User.find_by(id: session[:public_user_id]) if session[:public_user_id]
    end
